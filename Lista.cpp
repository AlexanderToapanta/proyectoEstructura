...
void Lista::insertar(Persona dato) {
    if (verificarCedula(dato.getCedula())) {
    ...
    // Llamar a desencriptarContrasena con el objeto Persona completo
    std::string contrasenaDesencriptada = desencriptarContrasena(dato);
    dato.setContrasenaDes(contrasenaDesencriptada);
    ...
    cedulasRegistradas.insert(dato.getCedula());
...
void Lista::guardarEnArchivo(const std::string& nombreArchivo) const {
    ...
    while (actual != nullptr) {
        ...
        archivo << "Correo: " << actual->dato.getCorreo() << "@espe.edu.ec"
            ...
            << ", De: " << actual->dato.getContrasenaDes() << std::endl;
...
void Lista::agregarAlArchivo(const Persona& dato) const {
    ...
    archivo << "Correo: " << dato.getCorreo() << "@espe.edu.ec"
        ...
        << ", Contrasenia: " << dato.getContrasena() 
        << ", Contraseniades: " << dato.getContrasenaDes() << std::endl;
}
