...
public:
    ...
    void setContrasenaDes(const string& cd) {
        contrasenaDes = cd;
    }

    string getContrasenaDes() const {
        return contrasenaDes;
    }
    ...
    friend ostream& operator<<(ostream& os, const Persona& persona) {
        os << "Nombre: " << persona.nombre << " " << persona.segundoNombre
            ...
            << ", ContraseniaDesencriptada: " << persona.contrasenaDes;
        return os;
    }
};
